...
/**
 * Access the current TemplatePanel context.
 * @returns Panel state and control helpers.
 * @throws Error when used outside a TemplatePanel.
 */
...
/**
 * Render a flexible panel with header/footer slots and optional states.
 * @param props - Panel props.
 * @returns The template panel element.
 */
    ...
    return (
      <div
        ...
        onMouseUp={() => {
          ...
          const newHeight = resizableRef.current.offsetHeight;
...
/**
 * Render the TemplatePanel header region.
...
/**
 * Render the TemplatePanel footer region.
