import svgPaths from "./svg-r8zfoz0n8f";
...
function IconMicLgDictate1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / mic-lg, dictate">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / mic-lg, dictate">
          <g id="vector">
            <path d={svgPaths.p2d151900} fill="var(--fill-0, #5D5D5D)" />
            <path d={svgPaths.p19748b00} fill="var(--fill-0, #5D5D5D)" />
          </g>
        </g>
      </svg>
    </div>
...
function IconMicLgDictate2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / mic-lg, dictate">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / mic-lg, dictate">
          <g id="vector">
            <path d={svgPaths.p2d151900} fill="var(--fill-0, #8F8F8F)" />
            <path d={svgPaths.p19748b00} fill="var(--fill-0, #8F8F8F)" />
          </g>
        </g>
      </svg>
    </div>
...
function IconMicLgDictate3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / mic-lg, dictate">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / mic-lg, dictate">
          <g id="vector">
            <path d={svgPaths.p2d151900} fill="var(--fill-0, white)" />
            <path d={svgPaths.p19748b00} fill="var(--fill-0, white)" />
          </g>
        </g>
      </svg>
    </div>
...
function IconMicLgDictate5() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / mic-lg, dictate">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / mic-lg, dictate">
          <g id="vector">
            <path d={svgPaths.p2d151900} fill="var(--fill-0, #CDCDCD)" />
            <path d={svgPaths.p19748b00} fill="var(--fill-0, #CDCDCD)" />
          </g>
        </g>
      </svg>
    </div>
...
function IconMicLgDictate6() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / mic-lg, dictate">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / mic-lg, dictate">
          <g id="vector">
            <path d={svgPaths.p2d151900} fill="var(--fill-0, #AFAFAF)" />
            <path d={svgPaths.p19748b00} fill="var(--fill-0, #AFAFAF)" />
          </g>
        </g>
      </svg>
    </div>
...
export default function Frame() {
  return (
    <div className="content-stretch flex gap-[32px] items-start overflow-clip relative rounded-[16px] size-full">
      <ColorLight />
      <ColorDark />
    </div>
  );
