  ...
  args: {
    ...
    children: (
      <div className="space-y-2 max-w-md">
        <p className="text-white/80">This is a section with longer content to demonstrate how the collapsible behavior works with more text.</p>
        ...
        <p className="text-white/80">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
      </div>
    ),
  },
};