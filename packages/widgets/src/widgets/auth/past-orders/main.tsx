    ...
    <div className="antialiased w-full text-black rounded-2xl border border-black/10 bg-white overflow-hidden">
      <div className="flex flex-wrap items-center gap-3 px-5 py-4 border-b border-black/5">
        ...
        <div className="min-w-0">
          ...
          <div className="text-sm text-black/60">Synced from your account</div>
        </div>
        <div className="ml-auto text-xs uppercase tracking-wide text-black/40">Last 30 days</div>
      </div>
      <div className="flex flex-col">
        ...
        {safeOrders.length === 0 && (
          <div className="px-5 py-8 text-center text-sm text-black/60">No past orders yet.</div>
        )}
      </div>
    </div>
  );
