  ...
  <Story name="IconButton API">
    {() => {
      ...
      return (
        <div className="p-4 space-y-4">
          <div className="flex gap-2">
            <IconButton icon={<span>📋</span>} variant="ghost" title="Copy" />
            <IconButton icon={<span>🔗</span>} variant="outline" title="Link" />
            <IconButton icon={<span>⚙️</span>} variant="solid" title="Settings" />
          </div>

          <div className="flex gap-2">
            <IconButton icon={<span>❤️</span>} size="sm" title="Small" />
            <IconButton icon={<span>❤️</span>} size="md" title="Medium" />
            <IconButton icon={<span>❤️</span>} size="lg" title="Large" />
          </div>
    ...
    {() => {
      ...
      return (
        <div className="p-4 space-y-4">
          ...
          <div className="text-white/60 text-sm">Selected: {selectedModel}</div>
        </div>
      );
    }}
...
<Canvas>
  <Story name="ContextTag API">
    <div className="p-4 space-y-4">
      ...
      <div className="flex flex-wrap gap-2">
        <ContextTag icon={<span>📄</span>} label="With icon" variant="green" size="sm" />
        <ContextTag
          icon={<span>📁</span>}
      ...
      return (
        <div className="p-4 space-y-4">
          <div className="flex items-center gap-4">
            ...
            <span className="text-white/80">{enabled ? "Enabled" : "Disabled"}</span>
          </div>
    ...
    {() => {
      ...
      return (
        <div className="p-4 space-y-6 max-w-md">
          ...
          <RangeSlider value={50} min={0} max={100} disabled showValue={false} />
        </div>
      );
    }}
...
```tsx
<Button style={{ "--button-radius": "12px" }}>Custom Radius</Button>
```
